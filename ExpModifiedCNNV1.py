...
model_preprocessors = {
    0: preprocess_vgg19,         # VGG19
    1: preprocess_resnet50,      # ResNet50
    2: preprocess_resnet50,      # ResNet101
    3: preprocess_resnet50v2,    # ResNet152V2
    4: preprocess_inceptionresnetv2,  # InceptionResNetV2
    5: preprocess_mobilenet,     # MobileNet
    6: preprocess_mobilenetv2,   # MobileNetV2
    7: preprocess_nasnetmobile,  # NASNetMobile
    8: preprocess_resnet50v2,    # ResNet50V2
    9: preprocess_resnet50v2,    # ResNet101V2
    10: preprocess_efficientnetv2, # EfficientNetV2B0
    11: preprocess_efficientnetv2, # EfficientNetV2B3
    12: preprocess_efficientnetv2, # EfficientNetV2S
    13: preprocess_efficientnetv2, # EfficientNetV2M
    14: preprocess_efficientnetv2, # EfficientNetV2L
}
...
# === LOAD DATA ===
def load_npz_train_test_split_custom(pathTrain, pathTest, sizeImage, sizeTest, resize_meth, model_type):
    '''
    Load and resize dataset, apply preprocess_input sesuai arsitektur model.
    '''
    # Mencari preprocess_input yang sesuai
    ...
    # Apply preprocess_input (important for pretrained models)
...
def main():
    ...
    if args.dataset == "mnist":
        ...
        X_train, y_train, X_val, y_val, X_test, y_test, y_test_label = load_npz_train_test_split_custom(
            pathTrain, pathTest, sizeImage, 0.2, args.resize_meth, model_index
        )
