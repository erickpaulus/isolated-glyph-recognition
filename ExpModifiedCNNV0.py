...
def main():
    ...
    # Model selection
    MODEL = ['VGG16','VGG19', 'ResNet50', 'ResNet101',
             'EfficientNetB0', 'EfficientNetB1', 'EfficientNetB2', 'EfficientNetB3']

    model_index = args.model_index  # Choosing MobileNet
    input_shape = X_train.shape[1:]
    # model = modelsV0.build_MobileNet(X_train.shape[1:], nb_classes, weight)
    if model_index == 0 : 
        model = modelsV0.build_VGG16(input_shape,nb_classes,weight)
    if model_index == 1 : 
        model = modelsV0.build_VGG19(input_shape,nb_classes,weight)
    elif model_index == 2:
        model = modelsV0.build_ResNet50(input_shape, nb_classes,weight)
    elif model_index == 3 :        
        model =modelsV0.build_ResNet101(input_shape, nb_classes,weight)
    elif model_index == 4 :
        model = modelsV0.build_EfficientNetB0(input_shape, nb_classes, weight)
    elif model_index == 5 :
        model = modelsV0.build_EfficientNetB1(input_shape, nb_classes, weight)
    elif model_index == 6 :
        model = modelsV0.build_EfficientNetB2(input_shape, nb_classes, weight)
    elif model_index == 7 :
        model = modelsV0.build_EfficientNetB3(input_shape, nb_classes, weight)
